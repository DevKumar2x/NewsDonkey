  ...
  render() {
    return (
      <div className="container">
        <h1 className='text-center' style={{margin:'40px'}}>News-Donkey - Top Headlines</h1>
        ...
        <div className="container d-flex justify-content-between">
          ...
          <button disabled={this.state.page >= Math.ceil((this.state.totalResults||0)/this.props.pageSize) || this.state.loading} type="button" className="btn btn-dark" onClick={this.handleNextClick} >Next &rarr;</button>
        </div>
      </div>
    )
  }
