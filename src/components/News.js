...
export class News extends Component {
  ...
  async UpdateNews() {
      const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=eee52a7a28e4497b96509996b48fcd7a&page=1&pageSize=${this.props.pageSize}`;
